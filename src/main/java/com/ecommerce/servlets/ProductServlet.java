...
public class ProductServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        products.add(new Product(2, "Smartphone", "Latest smartphone model", 58099,
            "https://images.unsplash.com/photo-1511707267537-b85faf00021e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80", 15));
        ...
        products.add(new Product(4, "Tablet", "10-inch tablet", 37349,
            "https://images.unsplash.com/photo-1544716278-ca5e3af8abd8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80", 12));
